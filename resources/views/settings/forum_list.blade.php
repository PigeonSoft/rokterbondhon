...
<div class="container">
    @if(\Illuminate\Support\Facades\Auth::check() && \Illuminate\Support\Facades\Auth::user()->is_admin == 1)
        <div class="forum pull-right"><a href="{{ route('organizations.create') }}" class="btn btn-danger">Add New Forum</a></div>
    @endif
        ...
        <tbody>
            ...
            <tr>
              ...
              <td>
                  ...
                  <a href="{{ route('organizations.edit', $forum->id) }}" class="btn-sm btn-info pull-left" style="margin-right: 3px;">Edit</a>
